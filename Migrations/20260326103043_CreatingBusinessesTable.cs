...
{
    /// <inheritdoc />
    public partial class CreatingBusinessesTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    profile_picture = table.Column<string>(type: "varchar(200)", nullable: true),
                    role = table.Column<string>(type: "text", nullable: false),
                    subsription_id = table.Column<string>(type: "text", nullable: true),
                    subsription_status = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    business_type = table.Column<string>(type: "varchar(100)", nullable: false),
                    ...
                    qr_code_token = table.Column<string>(type: "varchar(255)", nullable: false),
                    average_service_time = table.Column<int>(type: "integer", nullable: false),
                    is_queue_active = table.Column<bool>(type: "boolean", nullable: false),
                    is_queue_paused = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    auto_advance_enabled = table.Column<bool>(type: "boolean", nullable: false),
                    client_timeout_minutes = table.Column<int>(type: "integer", nullable: false),
